...
<div
  class="m-px flex flex-col divide-y divide-neutral-600 rounded-xl border border-neutral-500 bg-neutral-700 text-white outline outline-1 outline-neutral-900"
>
  <Header {file} />
