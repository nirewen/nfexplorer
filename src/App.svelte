...
<main class="flex h-screen min-h-0 gap-2 p-4">
  <div class="flex w-1/3 flex-col gap-2 overflow-y-auto rounded-xl">
    <div
  ...
  <div class="flex h-full w-full flex-col gap-2 overflow-y-auto rounded-xl">
